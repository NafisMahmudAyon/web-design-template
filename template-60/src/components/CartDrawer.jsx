            ...
            >
              ...
              <div className="px-6 py-5 border-b border-neutral-100 flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <h3 className="text-lg font-bold text-neutral-900 font-syne">
                    Shopping Cart
                  </h3>
                  <span className="text-xs bg-neutral-100 text-neutral-600 font-bold px-2 py-0.5 rounded-full ml-1">
                ...
                {cartItems.length === 0 ? (
                  <div className="h-full flex flex-col items-center justify-center text-center py-12">
                    ...
                    <p className="text-xs text-neutral-500 max-w-xs mb-6">
                      Explore our popular sneakers and new arrivals to find your perfect pair.
                    </p>
                    <button
                      onClick={onClose}
                      className="bg-neutral-900 text-white text-xs font-semibold px-5 py-2.5 rounded-full hover:bg-neutral-800 transition-all"
                    >
                      Start Browsing
                    </button>
                  </div>
                  ...
                  cartItems.map((item) => (
                    ...
                    >
                      <div className="w-20 h-20 bg-white rounded-xl flex items-center justify-center p-2 flex-shrink-0 border border-neutral-100">
                        <img
                          src={item.image}
                          alt={item.name}
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs text-neutral-500 mt-0.5">
                          Size: {item.selectedSize || 'US 9'} • {item.colorVariant || '1 COLOR'}
                        </p>
              ...
              {cartItems.length > 0 && (
                <div className="p-6 border-t border-neutral-100 bg-neutral-50 space-y-3">
                  ...
                  <button
                    onClick={onCheckout}
                    className="w-full mt-2 bg-[#FF5722] hover:bg-[#F4511E] text-white font-bold text-sm py-3.5 rounded-full transition-all duration-200 flex items-center justify-center gap-2 shadow-lg shadow-orange-500/20 active:scale-98"
                  >
