...
export default function DepositModal({ isOpen, onClose }) {
  ...
  const depositAddress = 'bc1q9x3t89x7a2q4y9z0w8v7u6t5s4r3e2w1q0xyz';
      ...
      <div className="bg-white dark:bg-slate-800 rounded-3xl max-w-md w-full p-6 shadow-2xl border border-slate-200 dark:border-slate-700 relative animate-in zoom-in-95 duration-200">
        ...
        <div className="flex items-center justify-between pb-4 border-b border-slate-100 dark:border-slate-700">
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 rounded-xl bg-[#FF5B37]/10 text-[#FF5B37] flex items-center justify-center font-black">
              +
            </div>
        ...
        <div className="space-y-4 mt-4">
              ...
              {['BTC', 'ETH', 'SOL', 'USDT'].map((asset) => (
                <button
                  ...
                  className={`py-2 px-3 rounded-xl text-xs font-bold transition-all ${
                    selectedAsset === asset
                      ? 'bg-[#FF5B37] text-white shadow-md shadow-[#FF5B37]/30'
          ...
          <div>
            ...
            <div className="flex items-center gap-2 bg-slate-100 dark:bg-slate-900/80 p-2.5 rounded-xl border border-slate-200 dark:border-slate-700">
              ...
              <button
                onClick={handleCopy}
                className="flex items-center gap-1 bg-[#FF5B37] hover:bg-[#E84A26] text-white text-xs font-bold px-3 py-1.5 rounded-lg transition-colors shadow-sm"
              >
