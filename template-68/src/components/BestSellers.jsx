...
import { BEST_SELLERS } from '../data/groceryData';

export default function BestSellers({ onAddToCart, onToggleWishlist, wishlistItems = [] }) {
  return (
        ...
        <div className="flex items-end justify-between gap-4 mb-10">
          <div>
            ...
            <h2 className="text-2xl sm:text-3xl font-black text-gray-900 tracking-tight">
              Best Seller <span className="text-[#0c6b3e]">Products</span>
            </h2>
          </div>
              ...
              >
                ...
                <div className="flex items-center justify-between pt-3 border-t border-gray-100">
                  ...
                  <button
                    ...
                    className="flex items-center gap-1.5 px-3.5 py-1.5 rounded-full border border-emerald-600/30 text-[#0c6b3e] hover:bg-[#0c6b3e] hover:text-white text-xs font-bold transition-all shadow-sm active:scale-95"
                  >
