...
import { footerData } from '../data/catalxgData';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 pb-16 border-b border-slate-200">
          ...
          <div className="lg:col-span-5 flex flex-col justify-between">
            <div>
              ...
              <h4 className="text-base font-bold font-display text-slate-900 mb-1.5">
              ...
              {subscribed ? (
                <div className="flex items-center gap-2 px-4 py-2.5 rounded-full bg-emerald-50 border border-emerald-200 text-emerald-700 text-xs font-semibold">
                  ...
                  <span>Subscribed! Check your inbox for your welcome insights.</span>
                </div>
              ) : (
                <form onSubmit={handleSubmit} className="flex items-center gap-2 max-w-md">
                  <div className="relative flex-1">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-4 py-2.5 bg-white border border-slate-200 rounded-full text-xs text-slate-800 placeholder-slate-400 focus:outline-none focus:border-brandOrange transition-colors"
                    />
                  </div>
                  <button
                    type="submit"
                    className="px-6 py-2.5 rounded-full bg-brandOrange hover:bg-brandOrange-hover text-white text-xs font-bold uppercase tracking-wider transition-colors shadow-sm shrink-0"
                  >
                    Subscribe
                  </button>
                </form>
                  ...
                  {col.links.map((link) => (
                    <li key={link}>
                      <a
                        ...
                        className="text-xs sm:text-sm text-slate-500 hover:text-brandOrange transition-colors block py-0.5"
                      >
                        {link}
                      </a>
                    </li>
