      ...
      `}>
        <div>
          ...
          <div className="p-4 border-b border-slate-100 flex items-center justify-between relative">
            ...
            {workspaceMenuOpen && (
              <div className="absolute top-16 left-3 right-3 bg-white border border-slate-200 shadow-xl rounded-2xl p-2 z-50">
          ...
          <div className="px-3 py-3 overflow-y-auto max-h-[calc(100vh-210px)] space-y-6">
            ...
            <div>
              <div className="flex items-center justify-between px-3 mb-1.5">
                ...
                <button className="text-slate-400 hover:text-slate-600 transition p-0.5 rounded">
