...
export default function DirectMessageModal({ contactEmail, isOpen, onClose }) {
  const [messages, setMessages] = useState([
    { sender: 'them', text: 'Hey Sajibur! Reviewing the Kanban milestone progress right now.', time: '10:30 AM' },
    { sender: 'me', text: 'Great, all cards in On Review have 8/8 milestones met.', time: '10:34 AM' },
  ]);
